...
def test_3D_SSD_registration(test_T1_1, test_T1_2, tmppath):
    ...
    #
    if sampler:
        mean_samples, _ = registrator.sample_param(burnin=n_burnins,
                                                    samples=n_samples,
                                                    sample_gamma=False,
                                                    sample_likelihood_parameters=False)

        registrator.deformedVoxelPositions = mean_samples
...
def test_3D_SSD_registration_Filters(test_T1_1, test_T1_2, tmppath):
