...
def test_3D_SSD_registration_affine(test_T1_1, test_T1_2, tmppath):
    ...
    # Check that we are actually minimizing the SSD between moving and fixed
    # This is a super weak test though
...
def test_3D_SSD_registration_Filters_affine(test_T1_1, test_T1_2, tmppath):
...
def test_3D_SSD_registration_rigid(test_T1_1, test_T1_2, tmppath):
...
@pytest.mark.skip(reason="Skipping SSD filters for now")
def test_3D_SSD_registration_Filters_rigid(test_T1_1, test_T1_2, tmppath):
