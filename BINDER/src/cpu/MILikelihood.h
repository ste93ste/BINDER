...
#ifndef MILIKELIHOOD_H
#define MILIKELIHOOD_H
...
class MILikelihood final : public Likelihood {
public:
    // Constructor
    MILikelihood(double alpha, const double* theta, int threads,
